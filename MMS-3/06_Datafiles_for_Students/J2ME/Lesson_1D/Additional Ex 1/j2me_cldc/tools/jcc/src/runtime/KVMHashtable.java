/*
 *	KVMHashtable.java	1.5	02/09/27
 *
...
public class KVMHashtable { 
    ...
    private Hashtable renames = new Hashtable();
    ...
    protected boolean mayBeRenamed(Object x) {
        Boolean b = (Boolean)renames.get(x);
        if (b == null) {
            return false;
        } else {
    ...
    protected int getKey(Object x) { 
        return getKey(x, false);
    }
    protected int getKey(Object x, boolean mayBeRenamed) { 
