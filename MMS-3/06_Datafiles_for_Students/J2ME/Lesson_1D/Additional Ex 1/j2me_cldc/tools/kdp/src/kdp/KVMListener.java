...
//			remoteSocket.shutdownOutput();
        ...
        try {
            ...
            while (remoteSocket == null) {
	            ...
	            remoteSocket = new Socket(options.getRemoteHost(), 
                    ...
                    System.err.println("VM not ready");
                    try {
                        Thread.sleep(2000);
	...
	if (useClassParser) {
	    ...
	    Log.LOGN(1, "VM Handshake return string: " + s);
	    Log.LOGN(1, "VM Handshake return options: " + option_bits);
		...
		System.out.println("Couldn't get list of classes from VM");
	    }
