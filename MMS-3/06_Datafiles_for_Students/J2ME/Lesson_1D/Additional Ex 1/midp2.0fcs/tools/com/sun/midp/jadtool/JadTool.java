...
/**
 * The JadTool is a commmand line interface to the AppDescriptor class.
 *
 * @see AppDescriptor
 * @see SignCert
...
public class JadTool {
    ...
    /** Keeps this class from being instatiated by the public. */
    private JadTool() { }
